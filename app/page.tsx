...
export default function Portfolio() {
  ...
  const projects = [
    ...
    },
    {
      ...
      tech: ["JavaScript", "PHP","MySQL", "Admin Dashboard", "Driver Dashboard", "Real-time Tracking"],
      link: "https://github.com/sachinaaoli/Waste_Management_System"
    }
  ];

  const skills = [
    "HTML/CSS", "JavaScript", "React.js", "Next.js", "C", "C++", "C#", "Java",
    "MySQL",  "Git", "Basic Software Testing"
  ];
